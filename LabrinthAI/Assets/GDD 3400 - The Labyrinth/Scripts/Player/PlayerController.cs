...
namespace  GDD3400.Labyrinth
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            EventManager.AddInvoker(GameplayEvent.Hide, hide);
        }
        ...
        private void Update()
        {
            ...
            if (Input.GetKeyDown(KeyCode.Z))
            {
                ...
                newBarrel.GetComponent<Barrel>().barrelInitialize(gameObject);
                hide.AddData(GameplayEventData.Player, gameObject);
                hide.Invoke(hide.Data);
